...
player3 = Player(firstName = "Mark", lastName = "Pysyk", position = "D",
    team = florida, height = """6' 1" """, weight = "200 lb", birthdate = "January 11, 1992", birthCity = "Sherwood Park",
    birthLocation = "AB", birthNation = "CAN", bio = """Pysyk doesn't consider himself a superstitious sort, but you wouldn't know it from watching his pregame ritual. He always dresses left-to-right: starting with the left skate, left glove, left shin pad, etc.
     And if he plays a good game or his team wins, he'll make a point of wearing the same suit-and-tie combination for the next game.""")
...
player4 = Player(firstName = "Tomas", lastName = "Tatar", position = "LW",
    team = montreal, height = """5' 10" """, weight = "185 lb", birthdate = "December 1, 1990", birthCity = "Ilava",
    birthLocation = "", birthNation = "SVK", bio = """Tatar appeared on track for a fourth straight 20-goal season with the Detroit Red Wings in 2017-18 when he was traded to the Vegas Golden Knights for three draft picks on Feb. 26, 2018.
...
player5 = Player(firstName = "Thomas", lastName = "Chabot", position = "D",
    team = ottawa, height = """6' 2" """, weight = "196 lb", birthdate = "January 30, 1997", birthCity = "Sainte-Marie",
    birthLocation = "QC", birthNation = "CAN", bio = """Chabot, a defenseman taken by the Ottawa Senators in the first round (No. 18) of the 2015 NHL Draft, had a solid rookie season in 2017-18, finishing with 25 points (nine goals, 16 assists) in 63 games.
     Chabot made the Senators out of training camp in 2016-17. But after playing in one game, against the Arizona Coyotes on Oct. 18, 2016, he was returned to Saint John of the Quebec Major Junior Hockey League.""")
...
player7 = Player(firstName = "Jack", lastName = "Eichel", position = "C",
    team = buffalo, height = """6' 2" """, weight = "200 lb", birthdate = "October 28, 1996", birthCity = "North Chelmsford",
    birthLocation = "MA", birthNation = "USA", bio = """The No. 2 pick in the 2015 NHL Draft, Eichel entered the League having experienced plenty of success at a young age.
...
player8 = Player(firstName = "David", lastName = "Pastrnak", position = "RW",
    team = boston, height = """6' 0" """, weight = "188 lb", birthdate = "May 25, 1996", birthCity = "Havirov",
    birthLocation = "", birthNation = "CZE", bio = """When Pastrnak walked on stage at the Wells Fargo Center in Philadelphia as the No. 25 player chosen in the 2014 NHL Draft by the Boston Bruins, he kissed his hand and pointed to the heavens.
     The tribute, personal and heartfelt, was for his father, an adviser, cheerleader, inspiration and hockey/life coach, who had died of cancer 13 months earlier. Milan Pastrnak had always dreamed of his son playing in the NHL, and now here was David slipping the famed Bruins jersey over his head.""")
